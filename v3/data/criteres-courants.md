...
```yaml
last_update: '2026-06-08T16:04:39.872359+00:00'
argent:
  taux_10y_us_reels_tips:
    valeur: 2.11
    valeur_normalisee: 0.6955800631800233
    valeur_ponderee: 0.6955800631800233
    ts: '2026-06-08T16:04:39.872359+00:00'
  mouvement_or_5j:
    valeur: -0.02101822767006334
    valeur_normalisee: -0.4026150380802014
    valeur_ponderee: -0.4026150380802014
    ts: '2026-06-08T16:04:39.872359+00:00'
  ratio_gold_silver:
    valeur: 63.20701650926226
    ts: '2026-06-08T16:04:39.872359+00:00'
  alpha_argent_vs_or_5j:
    valeur: -0.03485832157876467
    valeur_normalisee: -0.4548019291566526
    valeur_ponderee: -0.4548019291566526
    ts: '2026-06-08T16:04:39.872359+00:00'
  cftc_cot_silver:
    valeur: 24492.0
  ...
  flux_etf_slv_pslv_5j:
    valeur: -0.08186788828136549
    valeur_normalisee: -0.4604540694598301
    valeur_ponderee: -0.4604540694598301
    ts: '2026-06-08T16:04:39.872359+00:00'
  gate_regime_extreme:
    valeur: true
    ts: '2026-06-08T16:04:39.872359+00:00'
ble:
  ...
  geopolitique_mer_noire:
    ...
    ts: '2026-06-08T16:04:39.872359+00:00'
    synthese_rationale: 'Signaux contradictoires : news LONG (baisse production australienne,
      Chine lève interdiction Brésil) vs SHORT (screwworm, fonds réduisent longs,
      baisse prix). Prix -12% sur 20j suggère que le biais SHORT est déjà intégré,
      sans news fraîche high pour inverser.'
    nature: structurel
...
cac40:
  spread_oat_bund_10y:
    ...
    ts: '2026-06-08T16:04:39.872359+00:00'
  alpha_cac_vs_sp_5j:
    valeur: 0.027153435974282214
    valeur_normalisee: 0.8959113720643617
    valeur_ponderee: 0.8959113720643617
    ts: '2026-06-08T16:04:39.872359+00:00'
...
cacao:
  ...
  eudr:
    ...
    synthese_rationale: Dominance de news SHORT (demande faible, offre abondante,
      dollar fort) avec matérialité moyenne à élevée et fraîcheur récente, cohérent
      avec la baisse de prix de -5.36% sur 5j. La seule news LONG (Brésil exempt de
      fièvre aphteuse) est isolée et ne renverse pas le signal.
    nature: structurel
...
cafe:
  ...
  maladies_cabosses_rouille:
    ...
    synthese_rationale: Dominance de news SHORT récentes (tarifs US sur Brésil, pression
      ...
      9% sur 20j, ce qui réduit la conviction.
    nature: structurel
...
cuivre:
  mining_strikes_chili_perou:
    ...
    synthese_rationale: Dominance de news LONG matérialité élevée (Goldman Sachs objectif
      cuivre +10%, Trump tarifs cuivre) et fraîches (≤48h) malgré une baisse récente
      de -1.83% sur 5j. Le +3.11% sur 20j confirme la tendance haussière, et les news
      LONG récentes renforcent le biais.
    nature: structurel
  ...
  ratio_cuivre_or:
    valeur: 0.001461152050047882
    valeur_normalisee: 0.8137018541957413
    valeur_ponderee: 0.8137018541957413
    ts: '2026-06-08T16:04:39.872359+00:00'
  gate_regime_extreme:
    valeur: true
    ts: '2026-06-08T16:04:39.872359+00:00'
eurusd:
  ...
  usd_jpy_proxy_risk:
    valeur: 160.11274
    valeur_normalisee: 0.6073092377304498
    valeur_ponderee: 0.6073092377304498
    ts: '2026-06-08T16:04:39.872359+00:00'
  cftc_cot_eur_nets:
    valeur: 15729.0
...
nasdaq:
  ...
  sox_trend_5j:
    valeur: 578.19
    valeur_normalisee: 0.7380727960194163
    valeur_ponderee: 0.7380727960194163
    ts: '2026-06-08T16:04:39.872359+00:00'
  breadth_nasdaq100_ma50:
    valeur: 0.1644497179375091
    valeur_normalisee: -0.05709573709506624
    valeur_ponderee: -0.05709573709506624
    ts: '2026-06-08T16:04:39.872359+00:00'
  sentiment_ia_megacaps:
    ...
    synthese_rationale: Dominance de news SHORT à matérialité élevée (attaques Iran-Israël,
      vente tech, dollar fort, rotation sectorielle) malgré quelques accords IA positifs.
      Le prix a baissé de 2.99% sur 5j, cohérent avec le signal short.
    nature: ponctuel
  ...
  flux_etf_qqq_5j:
    valeur: -0.02982872916267776
    valeur_normalisee: -0.7680468361783227
    valeur_ponderee: -0.7680468361783227
    ts: '2026-06-08T16:04:39.872359+00:00'
  spread_nasdaq_russell2000:
    valeur: 434.93500000000006
    valeur_normalisee: 0.565498314521203
    valeur_ponderee: 0.565498314521203
    ts: '2026-06-08T16:04:39.872359+00:00'
  rsi_14j_ixic:
    valeur: 56.866212239729414
    ts: '2026-06-08T16:04:39.872359+00:00'
  gate_regime_extreme:
    valeur: true
    ts: '2026-06-08T16:04:39.872359+00:00'
or:
  ...
  cftc_cot_nets:
    ...
    ts: '2026-06-08T16:04:39.872359+00:00'
  flux_etf_or_5j:
    valeur: -0.030686207491946615
    valeur_normalisee: -0.24677525683313223
    valeur_ponderee: -0.24677525683313223
    ts: '2026-06-08T16:04:39.872359+00:00'
  tension_geopolitique:
    ...
    synthese_rationale: Majorité de news LONG à matérialité élevée et confirmées (escalade
      Iran-Israël, attaques missiles, frappes sur sites pétrochimiques) dominent le
      flux, malgré quelques news SHORT liées au dollar fort et aux attentes Fed. Le
      marché a baissé de 3.14% sur 20j, mais la fraîcheur et la matérialité des new
    nature: ponctuel
...
petrole:
  ...
  tension_geopol_moyen_orient:
    ...
    synthese_rationale: Multiples news de matérialité haute confirment une escalade
      militaire directe Iran-Israël avec frappes sur infrastructures pétrolières,
      menaçant l'offre via Ormuz. Malgré la baisse récente du prix (-14.45% sur 20j),
      la fraîcheur et la force du signal géopolitique (toutes les news datent du 8
      juin) d
    nature: ponctuel
    event_id: dbf9364e740a
    event_date: '2026-06-08T00:00:00+00:00'
...
sp500:
  ...
  hy_credit_spread:
    ...
    ts: '2026-06-08T16:04:39.872359+00:00'
  breadth_sp_ma50:
    valeur: 0.2804047689533601
    valeur_normalisee: -0.26219524293216445
    valeur_ponderee: -0.26219524293216445
    ts: '2026-06-08T16:04:39.872359+00:00'
  dxy_trend_20j:
    valeur: 118.8783
    valeur_normalisee: -0.22895973114507306
    ...
    ts: '2026-06-08T16:04:39.872359+00:00'
  flux_etf_spy_ivv_5j:
    valeur: -0.020302133580355264
    valeur_normalisee: -0.6571748493484044
    valeur_ponderee: -0.6571748493484044
    ts: '2026-06-08T16:04:39.872359+00:00'
  shiller_cape_fwd_pe:
    valeur: 41.57
    valeur_normalisee: 1.0
...
vix:
  ...
  tension_geopolitique_active:
    ...
    synthese_rationale: 'Dominance de news LONG à matérialité élevée et fraîcheur
      immédiate (08/06) : escalade Iran-Israël, attaques mutuelles, menace sur Ormuz.
      Les quelques signaux SHORT (apaisement) sont minoritaires et contredits par
      la majorité des faits. Le marché a baissé de 12% sur 20j, mais la concentration
      de news'
    nature: ponctuel
    event_id: dbf9364e740a
    event_date: '2026-06-08T00:00:00+00:00'
