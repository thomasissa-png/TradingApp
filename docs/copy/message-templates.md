...
```
⚪️ NO-TRADE  CAC40
Score calculé : 5,1/10 — seuil minimum : 6,5/10
Condition manquante : volume Xetra 8h05 insuffisant (+8% vs moyenne, seuil +20%)
...
Régime de marché : VIX à 28,4 — seuil de suspension 27,0 dépassé
En régime de panique, les backtests pré-calculés ne sont plus représentatifs
Reprise des signaux quand VIX < 25,0 sur clôture consécutive (prochaine évaluation demain)
```
